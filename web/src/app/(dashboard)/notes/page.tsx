...
export default function WebNotesPage() {
  ...
  const selectedNote = notes.find((n) => n.id === selectedNoteId) || filteredNotes[0];
  ...
  return (
    <div className="flex flex-1 flex-col gap-6 p-4 md:p-6 lg:p-8 max-w-7xl mx-auto w-full">
      ...
      <PageHeader
        kicker="RELAY · VAULT NOTES"
        title="Raw thoughts,"
        highlightText="polished state."
        description="Structured markdown notes with raw transcript backstop intact."
      />
      ...
      <div className="flex-1 flex flex-col md:flex-row gap-4 min-h-[540px]">
        ...
        {/* Detail Pane */}
        <main className="flex-1 flex flex-col bg-card rounded-lg border border-border p-6 overflow-y-auto">
          {selectedNote ? (
            <div className="space-y-6 flex-1 flex flex-col">
              ...
              <div className="space-y-2">
                ...
                <div className="p-4 rounded-lg bg-muted/20 border border-border text-xs text-muted-foreground italic leading-relaxed">
