...
## Corpus Check
- 159 files · ~100,913 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1388 nodes · 2279 edges · 134 communities (100 shown, 34 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `8b73440c`
...
4. `AppState` - 24 edges
5. `CommandError` - 20 edges
6. `compilerOptions` - 18 edges
7. `Relay — Changelog` - 18 edges
8. `cn()` - 17 edges
...
### Community 3 - "cn"
Cohesion: 0.18
Nodes (11): CHANGELOG_DATA, ChangelogModal(), ChangelogModalProps, Badge(), BadgeProps, badgeVariants, PopoverContent(), PopoverContext (+3 more)
...
Cohesion: 0.17
Nodes (38): AppSettings, HotkeySettings, KanbanCard, AppState, CaptureStatus, CommandError, emit_capture_state(), emit_capture_status_event() (+30 more)
...
Cohesion: 0.12
Nodes (19): RelayLogo(), RelayLogoProps, DEMO_NOTES, ScribbleNote, ScribbleViewer(), ScribbleViewerProps, DEFAULT_SETTINGS, ProviderSettings() (+11 more)

### Community 12 - "components.json"
Cohesion: 0.10
Nodes (19): aliases, components, hooks, lib, ui, utils, iconLibrary, registries (+11 more)

### Community 13 - "VaultManager"
Cohesion: 0.07
Nodes (47): Client, process_chat(), ProcessedPipelineResult, Result, TtsSettings, ExtractedActionItem, PipelineEngine, PipelineError (+39 more)

### Community 14 - "dependencies"
Cohesion: 0.12
Nodes (17): dependencies, class-variance-authority, clsx, @radix-ui/react-checkbox, @radix-ui/react-label, react, react-dom, relay-workspace (+9 more)
...
Cohesion: 0.12
Nodes (17): next, next-themes, radix-ui, sonner, dependencies, clsx, lucide-react, next (+9 more)

### Community 17 - "devDependencies"
Cohesion: 0.12
Nodes (17): eslint, eslint-config-next, shadcn, @tailwindcss/postcss, ts-node, @types/node, devDependencies, eslint (+9 more)
...
### Community 42 - "web/src/lib/utils.ts"
Cohesion: 0.09
...
Cohesion: 0.06
Nodes (35): [0.1.0] - 2026-08-19, [0.1.1] - 2026-08-19, [0.1.2] - 2026-08-19, [0.2.0] - 2026-08-19, [0.3.0] - 2026-08-19, [0.3.1] - 2026-08-19, [0.3.2] - 2026-08-19, [0.3.3] - 2026-08-19 (+27 more)
...
### Community 67 - "DictationPill.tsx"
Cohesion: 0.27
Nodes (14): CaptureStatePayload, PROCESSING_CAPTIONS, LANG_LABELS, PillSettingsPopover(), PillSettingsPopoverProps, STYLE_LABELS, CleanupStyle, DiagnosticInfo (+6 more)
...
### Community 75 - "Identifier"
Cohesion: 0.67
Nodes (3): Identifier, description, oneOf

### Community 78 - "TriggerSettings.tsx"
Cohesion: 0.22
Nodes (13): DictationPillProps, PTTWidget(), PTTWidgetProps, ChatPanel(), ChatTurn, Card, CardContent, CardDescription (+5 more)

### Community 83 - "index.ts"
Cohesion: 0.22
Nodes (9): KanbanBoard(), KanbanBoardProps, HotkeySettings, KanbanCard, PillPosition, ProviderSettings, SttSettings, TtsSettings (+1 more)

### Community 85 - "SttEngine"
Cohesion: 0.18
Nodes (15): c_int, ensure_default_model(), num_cpus(), Arc, Default, Mutex, Option, Path (+7 more)

### Community 86 - "DictationPill"
Cohesion: 0.50
Nodes (3): App(), DictationPill(), FloatingPill()

### Community 93 - "ShellScopeEntryAllowedArgs"
Cohesion: 0.67
...
## Knowledge Gaps
- **536 isolated node(s):** `name`, `private`, `version`, `type`, `dev` (+531 more)
...
- **Why does `AppState` connect `commands.rs` to `AudioRecorder`, `VaultManager`, `SttEngine`?**
  _High betweenness centrality (0.016) - this node is a cross-community bridge._
- **Why does `cn()` connect `cn` to `dropdown-menu.tsx`, `sidebar.tsx`, `web/src/lib/utils.ts`, `components/page.tsx`, `site-header.tsx`, `(dashboard)/layout.tsx`?**
