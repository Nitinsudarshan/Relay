...
## Corpus Check
- 156 files · ~73,415 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1242 nodes · 2260 edges · 129 communities (72 shown, 57 thin omitted)
...
4. `AppState` - 29 edges
5. `Relay — Changelog` - 29 edges
6. `CommandError` - 28 edges
...
## Communities (129 total, 57 thin omitted)
...
Cohesion: 0.09
Nodes (36): Client, ExtractedActionItem, PipelineEngine, PipelineError, ProcessedPipelineResult, Error, Option, Result (+28 more)
...
Cohesion: 0.11
Nodes (21): DEMO_NOTES, ScribbleNote, SettingsSection, CHANGELOG_DATA, ChangelogDialog(), ChangelogDialogProps, AuthMode, RelayLogo() (+13 more)
...
### Community 15 - "HotkeyRecorder.tsx"
Cohesion: 0.43
...
Cohesion: 0.12
Nodes (17): dependencies, class-variance-authority, clsx, @radix-ui/react-checkbox, @radix-ui/react-dropdown-menu, @radix-ui/react-tabs, react-dom, tailwind-merge (+9 more)
...
Cohesion: 0.15
Nodes (15): ChatTurn, KanbanBoardProps, Badge(), BadgeProps, badgeVariants, Card, CardContent, CardDescription (+7 more)

### Community 27 - "index.ts"
Cohesion: 0.14
Nodes (15): countWords(), formatNoteTimestamp(), VaultViewState, VoiceNotePage(), ChangelogEntry, ChangelogItem, HotkeySettings, PillPosition (+7 more)
...
### Community 34 - "ProviderSettings.tsx"
Cohesion: 0.33
Nodes (5): DEFAULT_SETTINGS, ProviderSettings(), SettingsSection, Switch, SwitchProps
...
Cohesion: 0.25
Nodes (7): [0.1.2] - 2026-08-19, [0.3.6] - 2026-08-19, [0.7.1] - 2026-08-20, Complete UI Design Pass & Theme System Refactoring, Dynamic Changelog, 1-Click Theme Toggle & UI Streamlining, Murmur Push-to-Talk Pill Design & Edge-Flush Placement, Relay — Changelog
...
### Community 52 - "cn"
Cohesion: 0.15
Nodes (11): App(), DictationPill(), FloatingPill(), ThemeMode, ThemeToggle(), PopoverContent(), PopoverContext, PopoverProps (+3 more)
...
Cohesion: 0.18
Nodes (12): TAB_LABELS, ChangelogModal(), ChangelogModalProps, RelayLogo(), RelayLogoProps, DEMO_NOTES, ScribbleNote, ScribbleViewer() (+4 more)
