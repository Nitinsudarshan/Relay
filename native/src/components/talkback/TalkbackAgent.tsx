...
const PALETTE: Record<AgentVisualState, { core: string; badge: string }> = {
  idle: { core: 'text-muted-foreground', badge: 'bg-muted/50 text-muted-foreground border-border' },
  listening: { core: 'text-emerald-500 dark:text-emerald-400', badge: 'bg-emerald-500/10 text-emerald-500 border-emerald-500/30' },
  thinking: { core: 'text-indigo-400 dark:text-indigo-300', badge: 'bg-indigo-500/10 text-indigo-400 border-indigo-500/30' },
  speaking: { core: 'text-teal-500 dark:text-teal-300', badge: 'bg-teal-500/10 text-teal-400 border-teal-500/30' },
  interrupted: { core: 'text-amber-500 dark:text-amber-400', badge: 'bg-amber-500/10 text-amber-500 border-amber-500/30' },
  error: { core: 'text-destructive', badge: 'bg-destructive/10 text-destructive border-destructive/30' },
};
 ...
 *
 * An expressive, living AI entity that breathes when idle, reacts in real-time
