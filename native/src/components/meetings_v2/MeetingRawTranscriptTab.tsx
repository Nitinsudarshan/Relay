 ...
 *
 * This is the diagnostic view. It exists for verifying transcription quality,
 * inspecting what was actually heard, and recovering information when processing
 * fails — not as the polished meeting transcript. It is never modified by
 * normalization, summarization, or a speaker rename, which is what makes it
 * trustworthy for judging STT quality.
 */
        ...
        <div className="space-y-3">
          {segments.map((seg) => (
            ...
            >
              ...
              <p className="text-sm text-zinc-200 leading-relaxed font-mono text-[13px] select-text">
                {seg.text || (
...
export const RawTranscriptHidden: React.FC = () => (
  <div className="flex-1 flex flex-col items-center justify-center gap-2 p-8 text-center">
    ...
    <p className="text-sm font-medium text-zinc-400">Raw transcript is hidden</p>
