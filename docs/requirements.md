...
### 5. Dual Surfaces
- **FR-5.1 (Native Desktop)**: The Windows app MUST render a responsive floating PTT widget, Kanban board viewer, voice chat panel, trigger phrase config UI, and provider/STT/TTS/hotkey settings. *(The Kanban board viewer is deferred for the current phase — see Decision 33; implementation preserved, nav entry removed.)*
